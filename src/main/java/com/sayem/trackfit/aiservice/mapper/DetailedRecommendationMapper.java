...
public class DetailedRecommendationMapper {
    ...
    public DetailedRecommendation mapAiResponseToDetailedRecommendation(String aiResponse, FinishedExcercise finishedExcercise) {
        try {
            // Parse AI response to DTO
            AiResponseDto aiResponseDto = objectMapper.readValue(aiResponse, AiResponseDto.class);
            
            return DetailedRecommendation.builder()
                    .activityId(finishedExcercise.getId())
                    .userId(finishedExcercise.getUserId())
                    .activityType(finishedExcercise.getName().toString())
                    .duration(finishedExcercise.getDuration())
                    .caloryBurned(finishedExcercise.getCalories())
                    .summary(aiResponseDto.getSummary())
                    ...
                    // Safety (empty for now, can be added later)
                    .safety(new ArrayList<>())
                    .proTip(aiResponseDto.getProTip())
            ...
            // Return a fallback recommendation if JSON parsing fails
            return createFallbackRecommendation(aiResponse, finishedExcercise, e.getMessage());
        }
    }
    ...
    private DetailedRecommendation createFallbackRecommendation(String aiResponse, FinishedExcercise finishedExcercise, String errorMessage) {
        return DetailedRecommendation.builder()
                .activityId(finishedExcercise.getId())
                .userId(finishedExcercise.getUserId())
                .activityType(finishedExcercise.getName().toString())
